...
class nscd (
  ...
  $audit_user_positive_time_to_live = '600',
  $audit_user_negative_time_to_live = '20',
  $audit_user_keep_hot_count        = '20',
  ...
  $auth_attr_positive_time_to_live  = '600',
  $auth_attr_negative_time_to_live  = '20',
  $auth_attr_keep_hot_count         = '20',
  ...
  $bootparams_positive_time_to_live = '600',
  $bootparams_negative_time_to_live = '20',
  $bootparams_keep_hot_count        = '20',
  ...
  $ethers_positive_time_to_live     = '600',
  $ethers_negative_time_to_live     = '20',
  $ethers_keep_hot_count            = '20',
  ...
  $exec_attr_positive_time_to_live  = '600',
  $exec_attr_negative_time_to_live  = '20',
  $exec_attr_keep_hot_count         = '20',
  ...
  $ipnodes_positive_time_to_live    = '600',
  $ipnodes_negative_time_to_live    = '20',
  $ipnodes_keep_hot_count           = '20',
  ...
  $netmasks_positive_time_to_live   = '600',
  $netmasks_negative_time_to_live   = '20',
  $netmasks_keep_hot_count          = '20',
  ...
  $networks_positive_time_to_live   = '600',
  $networks_negative_time_to_live   = '20',
  $networks_keep_hot_count          = '20',
  ...
  $printers_positive_time_to_live   = '600',
  $printers_negative_time_to_live   = '20',
  $printers_keep_hot_count          = '20',
  ...
  $prof_attr_positive_time_to_live  = '600',
  $prof_attr_negative_time_to_live  = '20',
  $prof_attr_keep_hot_count         = '20',
  ...
  $project_positive_time_to_live    = '600',
  $project_negative_time_to_live    = '20',
  $project_keep_hot_count           = '20',
  ...
  $protocols_positive_time_to_live  = '600',
  $protocols_negative_time_to_live  = '20',
  $protocols_keep_hot_count         = '20',
  ...
  $rpc_positive_time_to_live        = '600',
  $rpc_negative_time_to_live        = '20',
  $rpc_keep_hot_count               = '20',
  ...
  $tnrhdb_positive_time_to_live     = '600',
  $tnrhdb_negative_time_to_live     = '20',
  $tnrhdb_keep_hot_count            = '20',
  ...
  $tnrhtp_positive_time_to_live     = '600',
  $tnrhtp_negative_time_to_live     = '20',
  $tnrhtp_keep_hot_count            = '20',
  ...
  $user_attr_positive_time_to_live  = '600',
  $user_attr_negative_time_to_live  = '20',
  $user_attr_keep_hot_count         = '20',
  ...
  case $::osfamily {
    'RedHat': {
      $default_config_template = 'nscd.conf.erb'
    ...
    'Solaris': {
      $default_config_template           = 'nscd.conf-Solaris.erb'
  ...
  if $config_template == 'USE_DEFAULTS' {
    $config_template_real = $default_config_template
  } else {
    $config_template_real = $config_template
  }
  ...
  if type($enable_db_audit_user) == 'boolean' {
  ...
  if type($enable_db_auth_attr) == 'boolean' {
  ...
  if type($enable_db_bootparams) == 'boolean' {
  ...
  if type($enable_db_ethers) == 'boolean' {
  ...
  if type($enable_db_exec_attr) == 'boolean' {
  ...
  if type($enable_db_ipnodes) == 'boolean' {
  ...
  if type($enable_db_netmasks) == 'boolean' {
  ...
  if type($enable_db_networks) == 'boolean' {
  ...
  if type($enable_db_printers) == 'boolean' {
  ...
  if type($enable_db_prof_attr) == 'boolean' {
  ...
  if type($enable_db_project) == 'boolean' {
  ...
  if type($enable_db_protocols) == 'boolean' {
  ...
  if type($enable_db_tnrhdb) == 'boolean' {
  ...
  if type($enable_db_tnrhtp) == 'boolean' {
  ...
  if type($enable_db_user_attr) == 'boolean' {
  ...
  file { 'nscd_config':
    ...
    path    => $config_path,
    content => template("nscd/${config_template_real}"),
    owner   => $config_owner,
    group   => $config_group,
    mode    => $config_mode,
